...
<acme:list>
	<acme:list-column code="patron.CHIMPUM.list.label.pattern" path="pattern"/>
	...
	<acme:list-column code="patron.CHIMPUM.list.label.startDate" path="startDate"/>
	<acme:list-column code="patron.CHIMPUM.list.label.finishDate" path="finishDate"/>
	<acme:list-column code="patron.CHIMPUM.list.label.budget" path="budget"/>
	<acme:list-column code="patron.CHIMPUM.list.label.link" path="link"/>
</acme:list>
